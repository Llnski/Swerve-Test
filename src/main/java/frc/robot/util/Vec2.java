...
public class Vec2 {
    ...
    // is Vec2 -> (this - other).norm() < 0.0001 // Inequality b/c weird floating
    // point errors
    // else -> throw Exception("Tried to check equality of Vec2 with something other
    // than a vector")
    // }
    ...
    // fun rotate(rad: Double) = Vec2(cos(rad) * x - sin(rad) * y, sin(rad) * x +
    // cos(rad) * y)
